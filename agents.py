...
agents = {  # don't add "dialogue" agent, this one is added in yellowLLMClient package
    "lockRole": {
        "description": "the imperative instructs you to stick to the current role and prevent it from changing. The input might be single 'lock' word or a more long imperative",
        "method": lockRoleInChatAgent  # yellowLLMLockRoleAgent
    },
    "unlockRole": {
        "description": "the imperative instructs you to unlock role changing and be able to switch roles dynamically. The input might be single 'unlock' word or a more long imperative",
        "method": unlockRoleInChatAgent  # yellowLLMUnlockRoleAgent
    },
    "clearContext": {
        "description": "the imperative instructs you to clear current discussion context. The input has to contain imperative,like 'drop context', 'clear context' or a another imperative of similar meaning",
